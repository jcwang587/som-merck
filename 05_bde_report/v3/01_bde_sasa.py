...
bde_mae_dir = "./bde_mae"
bde_mae_files = os.listdir(bde_mae_dir)
bde_mae_files.sort()

sasa_mae_dir = "./sasa_mae"
sasa_mae_files = os.listdir(sasa_mae_dir)
sasa_mae_files.sort()
...
for bde_file, sasa_file in zip(bde_mae_files, sasa_mae_files):
    bde_path = f"{bde_mae_dir}/{bde_file}"
    sasa_path = f"{sasa_mae_dir}/{sasa_file}"
